...
def every_bird_heuristic(state: State,
    ...
    if yellow_birds:
        for bird in yellow_birds:
            temp_birds.append(bird)
            if problem.maze_distance(position, bird) < distance:
    ...
    while temp_birds:
        ...
        for bird in temp_birds:
            if problem.maze_distance(current_bird, bird) < distance:
                distance = problem.maze_distance(current_bird, bird)
                temp = bird
